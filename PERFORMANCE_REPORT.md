...
| # | Suggestion | Rationale |
|---|---|---|
| 1 | **Add ramp-up** | Use k6 `stages` to gradually increase load (e.g. 30 s ramp to 100 VUs -> 4 min hold -> 30 s ramp down). This avoids slamming the server with 100 concurrent connections at once, gives time to observe how response times change under growing load, and produces a more realistic traffic pattern. |
